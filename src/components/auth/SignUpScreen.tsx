        ...
        <div className="mt-10 space-y-6">
          <div className="space-y-4">
            ...
            <div className="space-y-5">
              <EmailFieldWithAction onSendCode={() => setEmailCodeSent(true)} />
              {emailCodeSent ? (
                <TextField label="인증번호" placeholder="인증번호" />
              ) : null}
          ...
          <div className="space-y-3">
            ...
            <div className="space-y-3">
              <CheckboxRow label="개인정보수집동의" required />
              <CheckboxRow label="마케팅 수신동의" />
            </div>
          </div>
