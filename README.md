...
| `intelligenceApi` | AI Job, 구매 활용성, 스타일 플랜, 장소 |
...
FEATURE: LIGHTWEIGHT, COMPACT, SPACIOUS, MULTIWAY, STATEMENT, LOGO
```

`VERSATILE` 대신 구체적인 사용 방식을 나타내는 `MULTIWAY`를 사용합니다. `EXHIBITION`, `CAFE`는 Occasion이 아니라 장소 카테고리입니다.
